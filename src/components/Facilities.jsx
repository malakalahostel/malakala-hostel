  ...
  const facilitiesList = [
    {
      ...
      icon: <FaBookReader className="text-4xl mb-4 text-primary" />,
    ...
    },
    {
      ...
      icon: <FaTableTennis className="text-4xl mb-4 text-primary" />,
    ...
    <section id="facilities" className="py-20 bg-secondary">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16" data-aos="fade-up">
          ...
          <p className="mt-6 text-gray-600 max-w-2xl mx-auto">Providing everything a student needs to study, stay fit, and relax.</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {facilitiesList.map((item, index) => (
            <div 
              ...
              className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-50"
            >
